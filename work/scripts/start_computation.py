...
for size in [100]:
    for id_dataset in dataset:
        ...
        id_dataset = f"{id_dataset}_{size}_m7"
        buffer = utils.make_buffer(id_dataset, tables_path, cea_target_path, cpa_target_path, cta_target_path, kg_reference="wikidata", candidate_size=size)
        json_data = buffer
